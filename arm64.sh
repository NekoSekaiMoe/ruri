...
git clone https://github.com/Moe-Hacker/ruri 1
cd 1
cc -Wl,--gc-sections -ftree-vectorize -flto -funroll-loops -finline-functions -march=native -mtune=native -static src/*.c src/easteregg/*.c -o ruri -lcap -lseccomp -lpthread -Ofast -Wno-error
strip ruri
